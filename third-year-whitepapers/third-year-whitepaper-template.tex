...
%% -- Define path to .bib file -- %%
	\bibliography{abertay-whitepaper-template}
	\usepackage{float}
	\usepackage{listings}
	\usepackage{enumitem}
...
%% -- Appendix -- %%
	\begin{appendices}
		...
		\begin{enumerate}
			...
			\item{For the purposes of this section, the cases in which any content of a communication is to be taken to be made available to a person at a relevant time include any case in which any of the communication is diverted or recorded at a relevant time so as to make any content of the communication available to a person after that time.}		
		\end{enumerate}
